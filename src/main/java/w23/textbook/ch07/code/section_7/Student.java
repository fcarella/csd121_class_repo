package w23.textbook.ch07.code.section_7;

import java.util.ArrayList;

/**
   The Student class from How To 7.1, reimplemented with an array list.
   Note that most of the code is the same, with the [] replaced by calls
   to the get/set methods. However, the code for adding a score is
   simpler since we don't have to worry about running out of space.
   Also note the use of the enhanced for loop in the sum method.
*/
